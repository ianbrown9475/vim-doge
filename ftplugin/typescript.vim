" ==============================================================================
" The TypeScript documentation should follow the 'typedoc' conventions.
...
let b:doge_supported_doc_standards = doge#buffer#get_supported_doc_standards(['typedoc'])
...
"   <param-access> <param-name> = <param-default-value>
" ==============================================================================
let s:pattern_base = {
\  'parameters': {
...
\  'tokens': ['funcName', 'async', 'parameters'],
\})
...
\  'tokens': ['static', 'async', 'parameters'],
\})
...
\  'tokens': ['className', 'funcName', 'async', 'parameters'],
\})
...
\  'tokens': ['static', 'funcName', 'static', 'async',  'parameters'],
\})
...
"
" ==============================================================================
call doge#buffer#register_doc_standard('typedoc', [
